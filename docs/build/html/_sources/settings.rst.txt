...
.. note:: 
    ...
    This section describes how to assign settings for a phyddle analysis. Visit :ref:`Pipeline` to learn how settings determine the behavior of a phyddle analysis.
...
.. note:: 
    The list of setting descriptions will be expanded in the future.

The :ref:`Pipeline` provides descriptions for how phyddle settings impact
different pipeline analysis steps. This section provide detailed descriptions
for several powerful settings that are difficult to configure without a
