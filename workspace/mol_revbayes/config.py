...
args = {
    ...
    # Simulate settings             #
    #-------------------------------#
    'sim_command'       : f'rb sim_mol.Rev --args',   # exact command string, argument is output file prefix
    'sim_logging'       : 'verbose',        # verbose, compressed, or clean
    'start_idx'         : 0,                # first simulation replicate index
    'end_idx'           : 10000,            # last simulation replicate index
    'sim_batch_size'    : 10,               # number of simulations per batch

    #-------------------------------#
    # Format settings               #
    #-------------------------------#
    'encode_all_sim'    : 'T',              # encode all simulated datasets
    'num_char'          : 10,               # number of evolutionary characters
    'num_states'        : 4,                # number of states per discrete character
    'min_num_taxa'      : 10,
    'max_num_taxa'      : 500,
