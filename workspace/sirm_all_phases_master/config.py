...
args = {
  ...
  # Simulate                      #
  #-------------------------------#
  'sim_command'        : 'python3 ./sim_sirm_all_phases.py',   # Simulation command to run single job (see documentation)
  'sim_logging'        : 'clean',              # Simulation logging style       
  'start_idx'          : 0,                    # Start replicate index for simulated training dataset
  'end_idx'            : 10000,                # End replicate index for simulated training dataset
