...
args = {
    ...
    #-------------------------------#
    'proj'    : 'PJ_example',               # project name(s)
    ...
    #-------------------------------#
    'sim_command'       : 'python3 ./sim/PhyloJunction/sim_one.py ./sim/PhyloJunction/bisse_timehet.pj trs', # exact command string, argument is output file prefix
