...
In addition, phyddle is distributed with example scripts to simulate phylogenetic training datasets using `R <https://www.r-project.org/>`_, `Python <https://www.python.org/>`_, `RevBayes <http://revbayes.com>`_, `PhyloJunction <https://phylojunction.org/build/html/index.html>`_ and `MASTER <https://tgvaughan.github.io/MASTER/>`_. See :ref:`Examples` for more information.
